...
BOT_TOKEN = os.getenv("8612233870:AAE4SQxm5uivX_oIspTaNmLkX8MSU-AJrQM")
MONGODB_URI = os.getenv("mongodb+srv://DEVIL2005_db_User:WJnOEYADmg0V5TcQ@cluster0.aaizxtf.mongodb.net/?appName=Cluster0")
DATABASE_NAME = os.getenv("@devilhackspublic", "attack_bot")
API_URL = os.getenv("API_URL")
API_KEY = os.getenv("API_KEY")
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "2050280040").split(",")]
